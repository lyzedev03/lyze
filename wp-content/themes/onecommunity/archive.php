	...
	<div id="content">
		...
		<?php do_action( 'bp_before_archive' ); ?>
			...
			<?php if ( have_posts() ) : ?>
				...
				<?php dd_theme_content_nav( 'nav-above' ); ?>
...
<h1><a href="<?php the_permalink() ?>" rel="bookmark" title="Fixed link <?php the_title_attribute(); ?>"><?php the_title(); ?></a></h1>
	...
	<div class="blog-bottom">
		...
		<div class="blog-bottom-date"><?php the_time('M j, Y') ?></div><div class="blog-bottom-spacer"></div>
		<a class="blog-bottom-comments" href="<?php the_permalink() ?>#comments"><?php comments_number('0', '1', '%'); ?></a><div class="blog-bottom-spacer blog-bottom-spacer-last"></div>
	</div>
...
<div class="clear"></div>
		...
		<?php dd_theme_content_nav( 'nav-below' ); ?>
